...
- **Prose teaches; tables look things up.** Guide pages explain in flowing prose with examples; reference pages enumerate in tables and lists. Do not turn a tutorial into a wall of tables.
...
- Avoid guide pages that are just thin wrappers pointing to another page — either cover the topic properly or do not give it its own page.
